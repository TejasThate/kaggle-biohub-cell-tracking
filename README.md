...
| File | Description |
|------|-------------|
| `nbf_mod.ipynb` | Modular end-to-end pipeline: multi-scale DoG, sub-voxel centroid refinement, greedy KD-tree tracking, gap closing, division detection, and graph-based submission generation |
...
2. **Linking** — KD-Tree pruned Hungarian optimal bipartite assignment (20–50× faster than naïve)
...
- Node matching via Hungarian assignment per timestep (max 7 µm)
